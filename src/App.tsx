...
const SERVICES = [
  { 
    ...
    desc: "অত্যাধুনিক এআই টুলস ব্যবহার করে আকর্ষণীয় ভিডিও বিজ্ঞাপন যা আপনার সেলস বহু গুণ বাড়িয়ে দেবে।",
    icon: <Video /> 
  },
  { 
    title: "ক্রিয়েটিভ স্ক্রিপ্ট রাইটিং", 
    desc: "আপনার পণ্যের জন্য এমন কাহিনী ও স্ক্রিপ্ট যা গ্রাহকের মন জয় করবে মুহূর্তেই।",
    icon: <PenTool /> 
  },
  { 
    title: "ওয়েবসাইট ডেভেলপমেন্ট", 
    desc: "দ্রুতগতির, নিরাপদ এবং ইউজার-ফ্রেন্ডলি ওয়েবসাইট যা আপনার প্রফেশনালিজম প্রকাশ করবে।",
    icon: <Globe /> 
  },
  { 
    title: "ডিজিটাল মার্কেটিং", 
    desc: "ডেটা-ড্রিভেন মার্কেটিং স্ট্র্যাটেজি ব্যবহার করে সঠিক অডিয়েন্সের কাছে আপনার পণ্য পৌঁছে দেওয়া।",
    icon: <TrendingUp /> 
  },
  { 
    title: "এআই ভয়েস ওভার", 
    desc: "মানুষের মতোই স্বাভাবিক এবং প্রফেশনাল এআই ভয়েস ওভার সার্ভিস, যা আপনার ব্র্যান্ডিংকে করবে জীবন্ত।",
    icon: <Mic2 /> 
  }
];
...
const PROCESS = [
  ...
  { step: "০৩", title: "এআই প্রোডাকশন", desc: "অত্যাধুনিক এআই ব্যবহার করে নিঁখুতভাবে দ্রুত প্রজেক্টের প্রোডাকশন সম্পন্ন করি।" },
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-[100] bg-agency-black/80 backdrop-blur-xl border-t border-white/5 pb-safe">
        <div className="flex items-center justify-around h-20 px-4">
          {[
            ...
            { label: "প্রাইসিং", id: "pricing", icon: <CreditCard className="w-5 h-5" /> },
      ...
      <main className="relative z-10">
        ...
        <section className="relative px-6 pt-24 pb-32 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            >
              <div className="tag mb-6 inline-block tracking-[0.15em]">আগামী প্রজন্মের ডিজিটাল এজেন্সি</div>
              ...
              <p className="text-text-dim text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-12 font-medium">
                আমরা আধুনিক এআই প্রযুক্তির মাধ্যমে আপনার ব্র্যান্ডের জন্য তৈরি করি হাই-কনভার্টিং বিজ্ঞাপন, দুর্দান্ত স্ক্রিপ্ট এবং আধুনিক ওয়েবসাইট। আজই আপনার সাফল্যের যাত্রা শুরু করুন।
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
                ...
                >
                  ফ্রি কনসালটেশন নিন <ChevronRight className="w-4 h-4" />
                </button>
                <a 
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div>
              <span className="text-agency-purple font-bold tracking-widest text-xs uppercase mb-4 block">আমরা যা করি</span>
              <h2 className="text-4xl md:text-5xl font-bold font-display">আধুনিক এআই সার্ভিসসমূহ</h2>
            </div>
            <button 
              onClick={() => setActivePage('services')}
              className="btn-secondary flex items-center gap-2">সবগুলো দেখুন <ChevronRight className="w-4 h-4" /></button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {SERVICES.map((s, i) => (
              <motion.div 
                ...
                onClick={() => setActivePage('service-detail')}
              >
                ...
                <button className="text-xs font-bold uppercase tracking-widest text-[#f8fafc]/50 group-hover:text-agency-purple flex items-center gap-2 transition-colors">
        ...
        <section className="py-32 bg-white/[0.01]">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-text-dim mb-12 font-medium">আমরা গতানুগতিক ধারার বাইরে গিয়ে আধুনিক এআই এবং ডেটা অ্যানালাইসিস ব্যবহার করি যা আপনার ব্যবসার দ্রুত প্রবৃদ্ধি নিশ্চিত করে।</p>
              
              <div className="space-y-8">
                {[
                  { icon: <Zap />, title: "স্মার্ট এআই টেকনোলজি", desc: "আমরা লেটেস্ট এআই টুলস ব্যবহার করি যা সময় বাঁচায় এবং কাজের কোয়ালিটি নিশ্চিত করে।" },
                  { icon: <TrendingUp />, title: "ফলাফলমুখী মেথড", desc: "আমাদের প্রতিটি কাজ সেলস এবং ইউজার এঙ্গেজমেন্ট বাড়ানোর কথা মাথায় রেখে করা হয়।" },
                  { icon: <Users />, title: "অভিজ্ঞ ও দক্ষ টিম", desc: "আমাদের রয়েছে দক্ষ এআই ইঞ্জিনিয়ার এবং ক্রিয়েটিভ ডিজাইনারদের একটি সমন্বিত টিম।" },
        ...
        <section className="py-32 px-6">
          <div className="max-w-5xl mx-auto glass-card p-12 md:p-20 text-center relative overflow-hidden border-agency-purple/30">
            ...
            <p className="text-text-dim text-xl mb-12 max-w-2xl mx-auto relative z-10 font-medium">একটি ফ্রি কনসালটেশন সেশন বুক করুন এবং জানুন কীভাবে আমাদের স্মার্ট এআই সলিউশন আপনার ব্রান্ডিংকে পরবর্তী লেভেলে নিয়ে যেতে পারে।</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
              <button 
                onClick={() => setActivePage('contact')}
                className="btn-primary h-14 px-10 flex items-center gap-3"
              >
                <Sparkles className="w-5 h-5" /> ফ্রি অডিট শুরু করুন
              </button>
              <a 
                href="https://wa.me/01833282575" 
                target="_blank" 
        ...
        <div className="fixed bottom-28 lg:bottom-6 right-6 z-[100] flex flex-col gap-4 items-end">
          ...
          >
            ...
            <span className="absolute right-full mr-4 bg-white/10 backdrop-blur-md px-3 py-1.5 rounded-lg text-xs font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">WhatsApp মেসেজ দিন</span>
          </a>
        </div>
      </main>
    </div>
